...
from airflow.models.baseoperator import BaseOperator # DOC: updated module
from airflow.utils.decorators import apply_defaults # DOC: updated module
...
class ZipOperator(BaseOperator):
    ...
    template_ext = []
    ui_color = '#c2daf6'  # ZipOperator's Main Color: white  # todo: find better color # DOC: edited color code
    ...
    def __init__(
            ...
            path_to_save_zip,
            *args, **kwargs):
        super(ZipOperator, self).__init__(*args, **kwargs) # DOC: added this line
    ...
    def execute(self, context):
        ...
        #os.rename(zip_file_name, self.path_to_save_zip) DOC: commented this line
